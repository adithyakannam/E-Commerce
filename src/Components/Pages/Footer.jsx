...
const Footer = () => {
  ...
  return (
    <footer className="bg-slate-700 mt-10 text-center h-[25vh] flex flex-col justify-center items-center text-white text-lg p-4">
      <div className="mb-4">
      ...
      <div>
      <p><a href="https://new-site-60y.pages.dev/" className="text-blue-400 hover:underline">Credits</a></p>
      </div>
    </footer>
  );
};
